...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate, SuggestEmojiView.AnchorViewDelegate {
    ...
    private FrameLayout messageEditField;
    private GradientDrawable messageEditBackground;
    private InsetDrawable messageEditInsetDrawable;
...
//            }
        ...
        messageEditTextContainer.addView(emojiButton, LayoutHelper.createFrame(32, 32, Gravity.BOTTOM | Gravity.RIGHT, 3, 0, 0, 0));
...
//        doneButtonContainer.addView(doneButtonProgress, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT));
    ...
    private void createRecordAudioPanel() {
        ...
        recordedAudioPanel.addView(recordDeleteImageView, LayoutHelper.createFrame(32, 32));
...
//                }
        ...
        textFieldContainer.addView(botCommandsMenuButton, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, 32, Gravity.BOTTOM | Gravity.LEFT, 10, 8, 10, 8));
    ...
    private void createBotWebViewButton() {
        ...
        textFieldContainer.addView(botWebViewButton, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.BOTTOM));
    }
...
//        });
    ...
    private void createMessageEditText() {
        ...
        messageEditText.setPadding(0, dp(4), 0, dp(4));
